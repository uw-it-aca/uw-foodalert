...
import ResponsibilitiesTemplate from "./components/responsibilities-template.vue";
import ResponsibilitiesController from "./components/responsibilities-controller.vue";
...
Object.assign(window.vueData.components, {
  ...
  "responsibilities-template": ResponsibilitiesTemplate,
  "responsibilities-controller": ResponsibilitiesController
});
...
window.vueData.routes[0].children = window.vueData.routes[0].children.concat([
  ...
  { path: "ended", component: EndedController, name: "ended" },
  {
    ...
    component: ResponsibilitiesController,
