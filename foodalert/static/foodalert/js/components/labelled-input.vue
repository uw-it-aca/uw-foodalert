  ...
  <b-container fluid class="px-0 py-1">
    <b-form-group class="labelled-textarea mb-0" :label-for="'textarea-' + id">
      ...
      <b-form-checkbox-group
        ...
        @input="setState($event)"
      >
        <b-row v-for="box in boxes" class="mx-0">
          <b-form-checkbox :value="box">{{ box }}</b-form-checkbox>
          <br>
        </b-row>
      </b-form-checkbox-group>
      <b-container v-else-if="inputType=='buttons'" v-model="checked" :id="'button-' + id">
  ...
  props: {
    ...
    inputType: {
      ...
      validator: function(value) {
        return (
          ["textarea", "checkbox", "time", "buttons"].indexOf(value) !== -1
        );
      }
    },
    labelText: String,
