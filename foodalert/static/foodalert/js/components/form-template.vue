<template>
  <b-container fluid class="p-0">
      ...
      <form-category>
        ...
        <div v-if="v.form.description.$error">
          ...
          <p
            ...
            class="hasError"
          >The description must be shorter than 100 characters</p>
        </div>
        <labelled-input
          label-text="Quantity"
        ...
        <div v-if="v.form.quantity.$error">
          ...
          <p
            v-if="!v.form.quantity.maxLength"
            class="hasError"
          >The quantity must be shorter than 100 characters</p>
        </div>
        <labelled-input
          label-text="End Time"
          input-type="time"
        ...
        <div v-if="v.form.time.$error">
          ...
          <p
            v-if="!v.form.time.maxLength"
            class="hasError"
          >The time entry must be shorter than 20 characters</p>
        </div>
        <labelled-input
          label-text="Location"
        ...
        <div v-if="v.form.location.$error">
          ...
          <p
            v-if="!v.form.location.maxLength"
            class="hasError"
          >Description must be shorter than 40 characters</p>
        </div>
      </form-category>
      <hr>
    ...
    <b-container class="mb-4 d-flex justify-content-end">
      ...
      >Send Notification</b-link>
    </b-container>

    <popup-container :modal-show="this.modalShow" :mode="this.modalMode">
      <agreement-popup
        slot="default"
      ...
      <b-container slot="safeListConfirmation">
        ...
        <p class="text-center" v-for="food in this.foodList" :key="food">
          <strong>{{food}}</strong>
        </p>
        <p>
